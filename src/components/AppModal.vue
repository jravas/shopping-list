      ...
      <div>
        ...
        <div class="modal-content" v-if="!data.item && !data.edit">
          <div class="modal-body">
            ...
            <svg class="close" @click="$emit('close')" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 224.512 224.512" style="enable-background:new 0 0 224.512 224.512;" xml:space="preserve" width="25px" height="25px">
              <polygon points="224.507,6.997 217.521,0 112.256,105.258 6.998,0 0.005,6.997 105.263,112.254    0.005,217.512 6.998,224.512 112.256,119.24 217.521,224.512 224.507,217.512 119.249,112.254  " fill="#fff"/>
            </svg>
            <form style="width:100%" v-on:submit.prevent="addItem">
        ...
        <div class="modal-content" v-if="data.item && data.edit">
          <div class="modal-body">
            ...
            <form style="width:100%" v-on:submit.prevent="editItem">
              <div class="form-group">
                <input v-model="name" type="text" placeholder="Name">
              </div>
              <button>
        ...
        <div class="modal-content" v-if="data.item && !data.edit">
          <div class="modal-body">
            ...
            <form style="width:100%" v-on:submit.prevent="addToStock">
              <div class="form-group">
