            ...
            <form style="width:100%" v-on:submit.prevent="addItem('addScope')" data-vv-scope="addScope">
              <div class="form-group">
                <p :class="{ 'control': true }">
                  <input v-validate="'required'" :class="{'input': true, 'is-danger': errors.has('addScope.name') }" name="name" v-model="name" type="text" placeholder="Name">
        ...
        <div class="modal-content" v-if="data.item && data.edit">
          <div class="modal-body wrapper">
            ...
            <form style="width:100%" v-on:submit.prevent="editItem('editScope')" data-vv-scope="editScope">
              <div class="form-group">
                <p :class="{ 'control': true }">
                  <input v-validate="'required'" :class="{'input': true, 'is-danger': errors.has('editScope.name') }" name="name" v-model="name" type="text" placeholder="Name">
        ...
        <div class="modal-content" v-if="data.item && !data.edit">
          <div class="modal-body wrapper">
            ...
            <form style="width:100%" v-on:submit.prevent="addToStock('stockScope')" data-vv-scope="stockScope">
              <div class="form-group">
                <p :class="{ 'control': true }">
                  <input v-validate="'required'" :class="{'input': true, 'is-danger': errors.has('stockScope.price') }" name="price" v-model="price" type="number" placeholder="Price">
